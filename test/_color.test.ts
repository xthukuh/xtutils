...
describe('Color', () => {
	it('should return the correct Color.from -> value', () => {
	...
	// generic .get()
	it('should return the correct Color.parse -> value, format', () => {
	...
	// it('should return the correct Color.from -> value, format', () => {});
